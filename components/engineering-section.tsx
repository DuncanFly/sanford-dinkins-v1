    ...
    <section id="experience" className="bg-zinc-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-24 md:py-32">
        <div className="mb-12 sm:mb-16 md:mb-20">
          <p className="text-xs sm:text-sm uppercase tracking-[0.2em] text-zinc-400 mb-3 sm:mb-4 font-mono">
            Engineering Experience
          </p>
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-light text-zinc-900 tracking-tight">
            Site Civil Engineering
          </h2>
        </div>

        {/* Intro paragraphs */}
        <div className="max-w-3xl space-y-4 sm:space-y-6 mb-16 sm:mb-20 md:mb-24">
        ...
        <div className="mb-16 sm:mb-20 md:mb-24">
          <h3 className="text-lg sm:text-xl font-medium text-zinc-900 mb-6 sm:mb-8">Areas of Practice</h3>
          <ul className="grid sm:grid-cols-2 gap-x-8 sm:gap-x-12 md:gap-x-20 gap-y-3 sm:gap-y-4">
        ...
        <div className="grid md:grid-cols-2 gap-12 sm:gap-16 md:gap-20 pt-12 sm:pt-16 border-t border-zinc-200">
          <div>
            <h3 className="text-lg sm:text-xl font-medium text-zinc-900 mb-4 sm:mb-6">Professional Approach</h3>
          ...
          <div>
            <h3 className="text-lg sm:text-xl font-medium text-zinc-900 mb-4 sm:mb-6">Engineering Philosophy</h3>
            <div className="space-y-3 sm:space-y-4">
